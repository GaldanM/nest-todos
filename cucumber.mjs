...
// (node:4863) ExperimentalWarning: `--experimental-loader` may be removed in the future; instead use `register()`
...
export default {
	...common, format: ["@cucumber/pretty-formatter"], formatOptions: {
		theme: {
...
export const ci = {
	...common, format: ["html:cucumber-report.html"], publish: true,
}
